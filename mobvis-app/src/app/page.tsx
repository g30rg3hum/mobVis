      ...
      <div className="w-[500px] border border-black rounded-lg p-5 bg-white space-y-5 text-justify flex flex-col justify-center">
        <div className="space-y-1">
          ...
          <p>
            ...
            useful graphs, charts and plots around walking data inputted by the
            user. Gait parameters, also known as Digital Mobility Outcomes
        ...
        <div className="space-y-1">
          ...
          <p>
            ...
            multiple sclerosis, a condition which affects mobility. The hope is
            that generated visualisations will aid in forming conclusions about
            patient gait.
          </p>
        </div>
        <div className="space-y-1">
